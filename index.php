...
?>      
            <main id="main">
                ...
                <!-- Home Section -->
                <section class="home-section bg-gray parallax-2 bg-light-alfa-50" data-background="/resources/images/home.webp" id="home">
                    <div class="js-height-full">
                        ...
                        <div class="home-content container">
                            <div class="home-text">
                                ...
                                <h1 class="hs-line-8 font-alt mb-50 mb-xs-30">HMM k so.</h1>
                                <h2 class="hs-line-14 font-alt mb-50 mb-xs-30"> Welcome to my space</h2>
                                
                                <div class="local-scroll">
                                    
                                    <span class="d-none d-sm-inline-block">&nbsp;</span>
                                    <a href="#about" class="btn btn-mod btn-medium btn-round">EXPLORE</a>
                                </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mt-140 mt-lg-80 mb-140 mb-lg-80">
                                    <div class="banner-content">
                                        ...
                                        <div class="local-scroll">
                                            <a href="pages-contact-1.html" class="btn btn-mod btn-w btn-medium btn-round">Stream/Download</a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1 col-xl-8 offset-xl-2 align-center">
                    ...
                    <blockquote class="testimonial white">
                        <p>
                        <?php  echo $elem[0]['test'][$x]['title'];                        
                        ?>
                        </p>
                        <footer class="testimonial-author">
                        <?php  echo $elem[0]['test'][$x]['author']; ?>
                        </footer>
                    </blockquote>
                </div>
            </div>
