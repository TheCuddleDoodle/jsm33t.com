                    ...
                    <div class="js-height-full">
                        ...
                        <div class="home-content container">
                            <div class="home-text">
                                ...
                                <h2 class="hs-line-14 font-alt mb-50 mb-xs-30">MELANCHOLY</h2>
                                <h1 class="hs-line-6 font-alt mb-50 mb-xs-30">THE CHAOS WITHIN</h1>
                        ...
                        <div class="section-text mb-50 mb-sm-20">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <blockquote>
                                        <p>
                                        Some random dark mental gymnastics quote
                                        </p>
                                        <footer>
                                            - random author
                                        </footer>
                                ...
                                <div class="col-md-4 col-sm-6 mb-sm-50 mb-xs-30 center" >
                                  
                                    <div class="mb-10">
                                        <a href="#" class="btn btn-mod btn-circle btn-medium"><i class="fa fa-soundcloud"></i>&nbsp;Button</a>
                                        <a href="#" class="btn btn-mod btn-circle btn-medium"><i class="fa fa-spotify"></i>&nbsp;Button</a>
                                    </div>
                                    <div class="mb-10">
